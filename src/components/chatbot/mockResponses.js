...
const founderResponse = `Kodnexa was founded by Mohammad Sufian (AI Engineer) and Md Mozammil (Software Engineer).
...
const responses = [
  ...
  { terms: ['service', 'services', 'ai development', 'software development', 'web development', 'website', 'automation', 'python', 'machine learning', 'llm', 'generative ai', 'chatbot'], text: `Kodnexa services:
...
• Technology training and workshops` },
  { terms: ['hackathon', 'hackathons', 'training', 'workshop'], text: 'Kodnexa Hackathons are high-energy build experiences where students and teams collaborate, prototype practical ideas and ship working AI solutions. We also offer hands-on training and workshops for every experience level.' },
  { terms: ['internship', 'internships', 'career', 'careers'], text: 'Kodnexa offers technology-focused learning and internship opportunities for emerging builders. Contact us with your profile and area of interest to learn about current openings.' },
  { terms: ['project', 'projects', 'portfolio', 'technology'], text: 'Kodnexa builds AI-powered products, automation systems, enterprise software solutions and modern web applications designed for real-world impact.' },
  { terms: ['contact', 'email', 'phone', 'location', 'located', 'address', 'google map', 'map', 'book meeting', 'meeting', 'call'], text: `Contact Kodnexa:
...
Book Meeting: Visit our Contact page or email us to schedule a meeting.` },
  { terms: ['company', 'about', 'vision', 'mission', 'kodnexa'], text: 'Kodnexa makes advanced AI practical, accessible and impactful for startups, educational institutions and enterprises through intelligent products, automation systems and modern software solutions.' },
...
Thank you for visiting Kodnexa.
